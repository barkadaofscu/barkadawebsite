		...
		return(
            ...
            <ParallaxBanner
                    ...
                    layers={[
                        {
                            children: (
                                <div style={{width:"100%", height: "100%", backgroundImage: `url(${props.background})`, backgroundSize: "cover"}}>
                        ...
                        },
                        {
                            children: (
                                <div style={{textAlign: "right"}}>
                                    <p style={{fontSize: "60px", float: "right", marginRight: "5%", width:"auto", height:"25%", marginTop: "20%", color:"white"}}>{props.title}</p>
                                </div>
                            ),
                            amount: 0.5,
                            expanded: false
                        },
                        {
                            children: (
                                <div style={{textAlign: "right"}}>
                                    <p style={{fontSize: "20px", float: "right", marginRight: "5%", width:"25%", height:"25%", marginTop: "25%", color:"white"}}>
                                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin scelerisque malesuada dapibus. Nullam condimentum lectus sit amet est commodo pulvinar.
                                    </p>
                                </div>
                            ),
                            amount: 0.5,
