...
class About extends Component{
	...
	render(){
		...
		return(
			...
			<Parallax y={[0,"0%"]}>
				<div style={{width: "100%", height: "100vh", backgroundColor: "black", textAlign: "center", overflow: "auto"}}>
